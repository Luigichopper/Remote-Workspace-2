...
public class GuideRenderer extends HumanoidMobRenderer<GuideEntity, HumanoidModel<GuideEntity>> {
	...
	public ResourceLocation getTextureLocation(GuideEntity entity) {
		return new ResourceLocation("terra_craft:textures/entities/2022_04_27_terraria---guide-20248321.png");
	}
}
